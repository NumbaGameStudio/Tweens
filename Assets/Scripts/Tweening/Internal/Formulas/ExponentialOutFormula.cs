...
{
    /// <summary>
    /// Represent exponential formula with slowdown.
    /// </summary>
    internal sealed class ExponentialOutFormula : InternalFormula
    {
        /// <summary>
        /// Associated ease type.
        /// </summary>
        public override Ease Ease { get { return Ease.ExpoOut; } }
