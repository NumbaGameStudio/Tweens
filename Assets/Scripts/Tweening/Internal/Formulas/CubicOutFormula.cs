...
{
    /// <summary>
    /// Represent cubic formula with slowdown.
    /// </summary>
    internal sealed class CubicOutFormula : InternalFormula
    {
        /// <summary>
        /// Associated ease type.
        /// </summary>
        public override Ease Ease { get { return Ease.CubicOut; } }
        ...
        public override float Calculate(float interpolation)
        {
            ...
            --interpolation;
            return interpolation * interpolation * interpolation + 1f;
        }
    }
}