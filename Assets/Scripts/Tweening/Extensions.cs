...
namespace Numba.Tweening
{
    public static class Extensions
    {
        ...
        {
            return DoMoveAlongAxis(() => transform.position.x, (px) => ChangeTransformPosition(transform, Space.World, 0, px), x, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoMoveAlongAxis(() => transform.position.y, (py) => ChangeTransformPosition(transform, Space.World, 1, py), y, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoMoveAlongAxis(() => transform.position.z, (pz) => ChangeTransformPosition(transform, Space.World, 2, pz), z, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoPosition(transform, Space.World, new Vector3(x, y, z), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoPosition(transform, Space.World, position, duration, ease, loopsCount, loopType);
        }
        #endregion
        ...
        {
            return DoMoveAlongAxis(() => transform.localPosition.x, (lpx) => ChangeTransformPosition(transform, Space.Self, 0, lpx), x, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoMoveAlongAxis(() => transform.localPosition.y, (lpy) => ChangeTransformPosition(transform, Space.Self, 1, lpy), y, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoMoveAlongAxis(() => transform.localPosition.z, (lpz) => ChangeTransformPosition(transform, Space.Self, 2, lpz), z, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoPosition(transform, Space.Self, new Vector3(x, y, z), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoPosition(transform, Space.Self, localPosition, duration, ease, loopsCount, loopType);
        }
        #endregion
        ...
        private static Tween DoMoveAlongAxis(Func<float> axisValueGetter, Action<float> axisValueSetter, float axisValue, float duration, Ease ease = Ease.Linear, int loopsCount = 1, LoopType loopType = LoopType.Forward)
        {
            return Tween.Create(axisValueGetter(), axisValue, axisValueSetter, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoRotateAroundAxis(() => transform.eulerAngles.x, x, (eax) => transform.eulerAngles = SetVectorValue(transform.eulerAngles, 0, eax), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoRotateAroundAxis(() => transform.eulerAngles.y, y, (eay) => transform.eulerAngles = SetVectorValue(transform.eulerAngles, 1, eay), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoRotateAroundAxis(() => transform.eulerAngles.z, z, (eaz) => transform.eulerAngles = SetVectorValue(transform.eulerAngles, 2, eaz), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoRotation(transform, Space.World, Quaternion.Euler(x, y, z), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoRotation(transform, Space.World, Quaternion.Euler(eulerAngles), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoRotation(transform, Space.World, rotation, duration, ease, loopsCount, loopType);
        }
        #endregion
        ...
        {
            return DoRotateAroundAxis(() => transform.localEulerAngles.x, x, (leax) => transform.localEulerAngles = SetVectorValue(transform.localEulerAngles, 0, leax), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoRotateAroundAxis(() => transform.localEulerAngles.y, y, (leay) => transform.localEulerAngles = SetVectorValue(transform.localEulerAngles, 1, leay), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoRotateAroundAxis(() => transform.localEulerAngles.z, z, (leaz) => transform.localEulerAngles = SetVectorValue(transform.localEulerAngles, 2, leaz), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoRotation(transform, Space.Self, Quaternion.Euler(x, y, z), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoRotation(transform, Space.Self, Quaternion.Euler(localEulerAngles), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoRotation(transform, Space.Self, localRotation, duration, ease, loopsCount, loopType);
        }
        #endregion

        private static Tween DoRotateAroundAxis(Func<float> angleGetter, float axisValue, Action<float> angleSetter, float duration, Ease ease = Ease.Linear, int loopsCount = 1, LoopType loopType = LoopType.Forward)
        {
            return Tween.Create(angleGetter(), axisValue, angleSetter, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(transform.localScale.x, x, (lsx) => transform.localScale = SetVectorValue(transform.localScale, 0, lsx), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(transform.localScale.y, y, (lsy) => transform.localScale = SetVectorValue(transform.localScale, 1, lsy), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(transform.localScale.z, z, (lsz) => transform.localScale = SetVectorValue(transform.localScale, 2, lsz), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoLocalScale(transform, new Vector3(uniformScale, uniformScale, uniformScale), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return DoLocalScale(transform, new Vector3(x, y, z), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(transform.localScale, localScale, (ls) => transform.localScale = ls, duration, ease, loopsCount, loopType);
        }
        #endregion
        #endregion
        ...
        {
            return Tween.Create(rectTransform.anchoredPosition.x, x, (apx) => rectTransform.anchoredPosition = SetVectorValue(rectTransform.anchoredPosition, 0, apx), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.anchoredPosition.y, y, (apy) => rectTransform.anchoredPosition = SetVectorValue(rectTransform.anchoredPosition, 1, apy), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.anchoredPosition, new Vector2(x, y), (ap) => rectTransform.anchoredPosition = ap, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.anchoredPosition, anchoredPosition, (ap) => rectTransform.anchoredPosition = ap, duration, ease, loopsCount, loopType);
        }
        #endregion
        ...
        {
            return Tween.Create(rectTransform.anchoredPosition3D.x, x, (ap3dx) => rectTransform.anchoredPosition3D = SetVectorValue(rectTransform.anchoredPosition3D, 0, ap3dx), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.anchoredPosition3D.y, y, (ap3dy) => rectTransform.anchoredPosition3D = SetVectorValue(rectTransform.anchoredPosition3D, 1, ap3dy), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.anchoredPosition3D.z, z, (ap3dz) => rectTransform.anchoredPosition3D = SetVectorValue(rectTransform.anchoredPosition3D, 2, ap3dz), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.anchoredPosition3D, new Vector3(x, y, z), (ap3d) => rectTransform.anchoredPosition3D = ap3d, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.anchoredPosition3D, anchoredPosition3D, (ap3d) => rectTransform.anchoredPosition3D = ap3d, duration, ease, loopsCount, loopType);
        }
        #endregion
        ...
        {
            return Tween.Create(rectTransform.anchorMax.x, x, (amx) => rectTransform.anchorMax = SetVectorValue(rectTransform.anchorMax, 0, amx), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.anchorMax.y, y, (amy) => rectTransform.anchorMax = SetVectorValue(rectTransform.anchorMax, 1, amy), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.anchorMax, new Vector2(x, y), (am) => rectTransform.anchorMax = am, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.anchorMax, anchorMax, (am) => rectTransform.anchorMax = am, duration, ease, loopsCount, loopType);
        }
        #endregion
        ...
        {
            return Tween.Create(rectTransform.anchorMin.x, x, (amx) => rectTransform.anchorMin = SetVectorValue(rectTransform.anchorMin, 0, amx), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.anchorMin.y, y, (amy) => rectTransform.anchorMin = SetVectorValue(rectTransform.anchorMin, 1, amy), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.anchorMin, new Vector2(x, y), (am) => rectTransform.anchorMin = am, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.anchorMin, anchorMin, (am) => rectTransform.anchorMin = am, duration, ease, loopsCount, loopType);
        }
        #endregion
        ...
        {
            return Tween.Create(rectTransform.offsetMax.x, x, (omx) => rectTransform.offsetMax = SetVectorValue(rectTransform.offsetMax, 0, omx), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.offsetMax.y, y, (omy) => rectTransform.offsetMax = SetVectorValue(rectTransform.offsetMax, 1, omy), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.offsetMax, new Vector2(x, y), (om) => rectTransform.offsetMax = om, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.offsetMax, offsetMax, (om) => rectTransform.offsetMax = om, duration, ease, loopsCount, loopType);
        }
        #endregion
        ...
        {
            return Tween.Create(rectTransform.offsetMin.x, x, (omx) => rectTransform.offsetMin = SetVectorValue(rectTransform.offsetMin, 0, omx), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.offsetMin.y, y, (omy) => rectTransform.offsetMin = SetVectorValue(rectTransform.offsetMin, 1, omy), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.offsetMin, new Vector2(x, y), (om) => rectTransform.offsetMin = om, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.offsetMin, offsetMin, (om) => rectTransform.offsetMin = om, duration, ease, loopsCount, loopType);
        }
        #endregion
        ...
        {
            return Tween.Create(rectTransform.pivot.x, x, (px) => rectTransform.pivot = SetVectorValue(rectTransform.pivot, 0, px), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.pivot.y, y, (py) => rectTransform.pivot = SetVectorValue(rectTransform.pivot, 1, py), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.pivot, new Vector2(x, y), (p) => rectTransform.pivot = p, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.pivot, pivot, (p) => rectTransform.pivot = p, duration, ease, loopsCount, loopType);
        }
        #endregion
        ...
        {
            return Tween.Create(rectTransform.sizeDelta.x, x, (sdx) => rectTransform.sizeDelta = SetVectorValue(rectTransform.sizeDelta, 0, sdx), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.sizeDelta.y, y, (sdy) => rectTransform.sizeDelta = SetVectorValue(rectTransform.sizeDelta, 1, sdy), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.sizeDelta, new Vector2(x, y), (sd) => rectTransform.sizeDelta = sd, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(rectTransform.sizeDelta, sizeDelta, (sd) => rectTransform.sizeDelta = sd, duration, ease, loopsCount, loopType);
        }
        #endregion
        #endregion
        ...
        {
            return Tween.Create(material.color, color, (c) => material.color = c, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(material.GetColor(name), color, (c) => material.SetColor(name, c), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(material.mainTextureOffset, textureOffset, (to) => material.mainTextureOffset = to, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(material.mainTextureScale, textureScale, (ts) => material.mainTextureScale = ts, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(material.GetTextureOffset(name), textureOffset, (to) => material.SetTextureOffset(name, to), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(material.GetTextureOffset(name), textureScale, (ts) => material.SetTextureScale(name, ts), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(material.GetInt(name), value, (i) => material.SetInt(name, i), duration, ease, loopsCount, loopType);
        }

        public static Tween DoFloat(this Material material, string name, float value, float duration, Ease ease = Ease.Linear, int loopsCount = 1, LoopType loopType = LoopType.Forward)
        {
            return Tween.Create(material.GetFloat(name), value, (f) => material.SetFloat(name, f), duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(material.GetVector(name), vector, (v) => material.SetVector(name, v), duration, ease, loopsCount, loopType);
        }
        #endregion
        ...
        {
            return Tween.Create(audioSource.volume, volume, (v) => audioSource.volume = v, duration, ease, loopsCount, loopType);
        }
        #endregion
        ...
        {
            return Tween.Create(camera.fieldOfView, fieldOfView, (fov) => camera.fieldOfView = fov, duration, ease, loopsCount, loopType);
        }
        ...
        {
            return Tween.Create(camera.rect, rect, (r) => camera.rect = r, duration, ease, loopsCount, loopType);
        }
        #endregion
        ...
        {
            return Tween.Create(canvasGroup.alpha, alpha, (a) => canvasGroup.alpha = a, duration, ease, loopsCount, loopType);
        }
        #endregion
